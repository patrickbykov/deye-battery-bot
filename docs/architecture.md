...
```
   інвертор Deye
        │  (пристрій сам вивантажує телеметрію, каданс ~5 хв — виміряно 7 вер 2026)
        ▼
   Deye Cloud OpenAPI
   ...
   (Fly, stateless)                        bucket monitoring, retention 30 днів
                                                ...
                                                ▼
                                          Grafana Cloud (Free)
                                          дашборд + 5 правил алертів
                                          + Synthetics: GET / бота раз на 2 хв
                                                │
                        ┌───────────────────────┴────────────────────┐
                        │ webhook (Bearer),                          │ telegram, лише
                        │ усі правила алертів                        │ «бот не відповідає»
                        ▼                                            ▼
                  deye-battery-bot ──▶ підписники + адмін      адмін (страхувка)
